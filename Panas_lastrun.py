...
expName = 'Panas'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\r01fp16\\Desktop\\Panas 2\\Panas_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='You are now going to see a number of words that describe different feelings and emotions. Read each item and then mark the appropriate answer in the space next to that word. Indicate to what extent you feel these feelings/emotions right now, at the present moment. \n\nPlease press the "space bar" to continue.',
    font='Arial',
...
Text1 = visual.TextStim(win=win, name='Text1',
    text='default text',
    font='Arial',
    pos=(0, 0.25), height=0.1, wrapWidth=2.5, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
...
text_3 = visual.TextStim(win=win, name='text_3',
    ...
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=1.05, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0);
text_4 = visual.TextStim(win=win, name='text_4',
    ...
    font='Arial',
    pos=(0, -0.4), height=0.03, wrapWidth=2, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-3.0);
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('panas.xlsx'),
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    Text1.setText(adjective)
    rating.reset()
    # keep track of which components have finished
    PanasTestComponents = [Text1, rating, text_3, text_4]
